...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    newUser.password = await hashPasswod(req.body.password);
...
exports.login = catchAsync(async (req, res, next) => {
    ...
    if (!user || !(await user.correctPassword(password, user.password))) {
        return next(new AppError('Incorrect email or password', 451));
    }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    //     return next(new AppError('Check the new password.', 401));
    // }
    ...
    user.password = await hashPasswod(req.body.password);;
